...
(function (root, factory) {
  ...
  function WordFilter(api, parent, def) {
    ...
    this._rule_variants =
      typeof def == "undefined" ? "DN" : def["rule_variants"];
    // this._num_matched_comments =
    //   typeof def === "undefined" ? 0 : def["num_matched_comments"];
  }
      ...
      return this._api
        ...
        .then(
          function (rule) {
            ...
            this._rule_variants = rule.rule_variants;
          }.bind(this)
        );
    }
  };
  ...
  WordFilter.prototype.setRuleAction = function (rule) {
    ...
    if (!this.isFinalized()) {
      ...
      return this._api
        .updateRule(this.getId(), "toggle_rule_variants")
        .execute()
        .then(
          function (serialized) {
            this._id = serialized.id;
            this._rule_variants = serialized.rule_variants;
  ...
  WordFilter.prototype.serialize = function () {
    return {
      ...
      rule_variants: this._rule_variants,
    };
  };
